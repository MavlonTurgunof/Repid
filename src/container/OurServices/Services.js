    ...
    <div>
      <div className="max-w-7xl mx-auto my-16 flex lg:flex-row flex-col justify-between">
        ...
        <div className="lg:max-w-[42%]">
          <h1 className="text-[#0B0B0B] text-[48px] font-bold mb-4">
            Bizning Xizmatlar
          </h1>
          <p className="text-[#0B0B0B] text-[18px] font-medium leading-10 mb-4">
          ...
          <p className="text-[#0B0B0B] text-[18px] font-medium leading-10">
