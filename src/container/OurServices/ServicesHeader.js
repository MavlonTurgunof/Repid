...
function ServicesHeader({ contactRef }) {
  ...
  return (
    <>
      <Head>
        <title>Rapid Agency</title>
        <meta
          name="description"
          content="Rapid Agency, texnologiyalar va kreativ marketingda yetakchilik qiluvchi agentlik. Bizning ekspertlar jamoasi sizga zamonaviy dasturlar, raqamli marketing strategiyalari va IT maslahati orqali maqsadlaringizga erishishda yordam beradi."
        />
        <meta name="keywords" content="Rapid Agency, Marketing, IT Maslahati" />
      ...
      <header className="relative bg-cover bg-no-repeat bg-[url('/img/bg3.png'),url('/img/bg3.png')] h-[600px] lg:h-[500px] md:h-[450px] sm:h-[400px] text-white">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row px-4 overflow-x-hidden overflow-y-hidden">
          <div className="lg:text-left text-center lg:w-1/2 w-full xl:mt-[8%] mt-[20%] space-y-4 flex flex-col justify-center">
            ...
            {/* Buttons */}
            <div
              className="mt-[50px] flex flex-row gap-6 justify-center lg:justify-start items-center"
              data-aos="fade-up"
              data-aos-delay="300"
            >
              <Link
