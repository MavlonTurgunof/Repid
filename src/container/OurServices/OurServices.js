        ...
        <div className="flex lg:flex-row flex-col justify-between">
          ...
          <div className="lg:max-w-[42%] lg:mt-0 mt-8 mx-[2%]">
            ...
            <p className="text-left text-[#0B0B0B] text-[18px] font-medium leading-10 mb-4">
              Repid Agentligida biz mijozlarimizning o'ziga xos ehtiyojlariga
              mos keladigan keng ko'lamli IT xizmatlarini taqdim etamiz. Bizning
              maqsadimiz o'sishni rag'batlantiruvchi, samaradorlikni oshiruvchi
              va raqamli tajribani yengillashtiruvchi yechimlarni taqdim
              etishdir.
            </p>
            <p className="text-left text-[#0B0B0B] text-[18px] font-medium leading-10">
              -Maxsus Veb-sayt Dizayni va Ishlab Chiqish: Biznesingiz
              maqsadlariga moslashtirilgan individual yechimlarni yaratish.
              <br />
