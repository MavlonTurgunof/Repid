        ...
        <div className="container mx-auto lg:mt-20 mt-4 w-11/12 overflow-hidden lg:px-20">
            ...
            <div className="grid grid-cols-3 gap-5 pb-20 max-xl:grid-cols-2 max-md:grid-cols-1">
                <div className="h-full">
                    <div
                        className="flex h-full flex-col items-center justify-center gap-5 rounded-xl border border-[#e3e5fa] p-6 px-10 md:transition-all md:hover:-translate-y-1 md:hover:scale-105 md:hover:border-none md:hover:shadow-2xl">
                        <div className=""><Image src={kok} alt={"Repid"}/></div>
                ...
                <div className="h-full">
                    <div
                        className="flex h-full flex-col items-center justify-center gap-5 rounded-xl border border-[#e3e5fa] p-6 px-10 md:transition-all md:hover:-translate-y-1 md:hover:scale-105 md:hover:border-none md:hover:shadow-2xl">
                        <div className=""><Image src={sariq} alt={"Repid"}/></div>
                ...
                <div className="h-full">
                    <div
                        className="flex h-full flex-col items-center justify-center gap-5 rounded-xl border border-[#e3e5fa] p-6 px-10 md:transition-all md:hover:-translate-y-1 md:hover:scale-105 md:hover:border-none md:hover:shadow-2xl">
                        <div className=""><Image src={olovrang} alt={"Repid"}/></div>
                ...
                <div className="h-full">
                    <div
                        className="flex h-full flex-col items-center justify-center gap-5 rounded-xl border border-[#e3e5fa] p-6 px-10 md:transition-all md:hover:-translate-y-1 md:hover:scale-105 md:hover:border-none md:hover:shadow-2xl">
                        <div className=""><Image src={havorang} alt={"Repid"}/></div>
                        <h4 className="text-center text-xl font-bold">
                ...
                <div className="h-full">
                    <div
                        className="flex h-full flex-col items-center justify-center gap-5 rounded-xl border border-[#e3e5fa] p-6 px-10 md:transition-all md:hover:-translate-y-1 md:hover:scale-105 md:hover:border-none md:hover:shadow-2xl">
                        <div className=""><Image src={yashil} alt={"Repid"}/></div>
                        <h4 className="text-center text-xl font-bold">
