    ...
    <div className="py-8 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <p className="text-[#D8D8D8] mb-6 sm:mb-8 lg:mb-10 w-full max-w-[790px] text-center px-4 sm:px-6">
          ...
          hoziroq murojaat qilsangiz, barcha xizmatlarimizga 30% chegirma taqdim
          etiladi. Shoshiling, imkoniyatni qo‘ldan boy bermang!
        </p>
        <div className="flex flex-col items-center justify-center h-auto text-black max-w-7xl mx-auto rounded-lg mb-8">
          <div className="flex items-center space-x-4 lg:flex-row flex-col">
            ...
            <span className="text-3xl sm:text-4xl text-[#FAD007] mb-4">:</span>
        ...
        <button className="mt-8 px-6 py-4 bg-[#1D1C34] border-[#D8D8D8] border-2 rounded-[16px] shadow-md hover:bg-gray-800 text-[#D8D8D8]">
          Bog'lanish
        </button>
