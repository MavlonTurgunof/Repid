...
function MainHeader({ contactRef }) {
  ...
  return (
    <header className="relative bg-cover bg-no-repeat overflow-hidden bg-[url('/img/Shade.png'),url('/img/MainHeader.png')] h-[600px] lg:h-[500px] md:h-[450px] sm:h-[400px] text-white">
