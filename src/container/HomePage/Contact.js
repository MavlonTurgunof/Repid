...
const ContactUs = () => {
  ...
  return (
    <div className="bg-[url('/img/contact.png')] h-[800px] bg-no-repeat bg-center bg-cover p-5">
      {/* Content Section */}
      <div className="flex flex-col lg:flex-row h-full w-full items-center justify-between container mx-auto space-y-5 lg:space-y-0">
        {/* Left Section: Contact Info */}
        <div className="text-white lg:w-1/2 w-full text-center lg:text-left space-y-5">
          <h2 className="text-4xl lg:text-5xl font-bold mb-4 max-sm:text-3xl mt-6">
          ...
          <div className="flex flex-col space-y-4 text-lg">
            ...
            <p className="flex items-center justify-center lg:justify-start">
              <i className="fas fa-map-marker-alt mr-2"></i> , California
            </p>
            <Link
